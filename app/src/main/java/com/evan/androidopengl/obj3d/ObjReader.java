...
public class ObjReader {
    private static final String Tag = "ObjReader";
    ...
    public static List<Obj3D> readMultiObj(Context context, String filePath) {
        ...
        try {
            ...
            Log.i(Tag, "readMultiObj: " + filePath);
            if (filePath.startsWith("assets/")) {
                ...
                isAssets = false;
                parent = filePath.substring(0, filePath.lastIndexOf("/") + 1);
